...
def main():
    ...
    savings_interest = float(input("Enter the annual interest rate (percentage) for the savings account: "))
    months = int(input("Enter the number of months for the savings account: "))

    # Call the create_savings_account function and pass the variables from the user.
    updated_savings_balance, interest_earned = create_savings_account(savings_balance, savings_interest, months)
    ...
    cd_balance = float(input("Enter the starting balance for the CD account: "))
    cd_interest = float(input("Enter the annual interest rate (percentage) for the CD account: "))
    months = int(input("Enter the number of months for the CD account: "))

    # Call the create_cd_account function and pass the variables from the user.
    updated_cd_balance, interest_earned = create_cd_account(cd_balance, cd_interest, months)
